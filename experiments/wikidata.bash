...
# original corrected
java -jar ../build/libs/sage-sparql-void-fat-1.0.jar sportal-sparql-endpoint https://query.wikidata.org/sparql ../output/original-corrected --sportalFile=../data/original-sportal-corrected.json
