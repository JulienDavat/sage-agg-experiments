...
# init
docker exec -t sage-agg sage-postgres-init /opt/data/datasets/experiments.yaml bsbm1k
# add
...
# add
docker exec -t sage-agg sage-postgres-put --format ttl /opt/data/datasets/dbpedia351.ttl /opt/data/experiments.yaml dbpedia351
