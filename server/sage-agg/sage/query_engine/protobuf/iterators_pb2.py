...
_SAVEDPROJECTIONITERATOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='graph', full_name='iterators.SavedProjectionIterator.graph', index=5,
...
_SAVEDAGGREGATESPROJECTIONITERATOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='graph', full_name='iterators.SavedAggregatesProjectionIterator.graph', index=6,
...
_SAVEDDISTINCTITERATOR.fields_by_name['filter_source'].containing_oneof = _SAVEDDISTINCTITERATOR.oneofs_by_name['source']
_SAVEDDISTINCTITERATOR.oneofs_by_name['source'].fields.append(
...
SavedDistinctIterator = _reflection.GeneratedProtocolMessageType('SavedDistinctIterator', (_message.Message,), dict(
...
SavedGroupByAgg = _reflection.GeneratedProtocolMessageType('SavedGroupByAgg', (_message.Message,), dict(
...
SavedAggregator = _reflection.GeneratedProtocolMessageType('SavedAggregator', (_message.Message,), dict(
